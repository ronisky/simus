        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <a class='float-right btn btn-primary btn-sm' href='<?= base_url('admin/tambah_halaman'); ?>'><i class="fas fa-plus fa-fw mr-1"></i>Tambah Halaman</a>
            </div>
                ...
                <tbody>
                  ...
                  foreach ($record->result_array() as $row) {
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$tgl_artikel</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Ubah' href='" . base_url() . "admin/edit_halaman/" . encrypt_url($row['id_halaman']) . "'><i class='fas fa-edit fa-fw'></i></a>
