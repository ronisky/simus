                    ...
                    <div class="card">
                        ...
                        <div class="card-body profile-card__body">
                            ...
                            <div class="profile-card__edit mt-2">
                                <a href="<?= base_url('admin/edit_profile') ?>" class="btn btn-secondary btn-sm">Ubah Profile</a>
                            </div>
                        </div>
                        <div class=" card address-card address-card--featured">
                            <div class="card-body profile-card__body">
                                ...
                                <?php } ?>
                                <div class="profile-card__edit mt-2">
                                    <a href="<?= base_url('admin/edit_alamat') ?>" class="btn btn-primary btn-sm">Ubah Alamat</a>
                                </div>
                            </div>
                        </div>
                    </div>
