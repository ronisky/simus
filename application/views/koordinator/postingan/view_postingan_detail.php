          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type='text' class='form-control' name='judul' value="<?= $rows['tanggal'] ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type='text' class='form-control' name='judul' value="<?= $rows['username'] ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <a href='<?= base_url('koordinator/postingan') ?>'><button type='button' class='btn btn-secondary btn-sm ml-1'>Batal</button></a>
                </div>
              </div>
