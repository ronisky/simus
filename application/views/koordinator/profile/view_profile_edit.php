      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form action="<?= base_url('koordinator/edit_profile') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <a href='<?= base_url('koordinator/profile'); ?>'><button type='button' class='btn btn-secondary btn-sm ml-1'>Batal</button></a>
                  </div>
                </div>
              </div>
            </form>
