        ...
        <div class="product__gallery">
            <div class="product-gallery">
                <div class="product-gallery__featured"><button class="product-gallery__zoom"><svg width="24px" height="24px">
                    ...
                    <div class="owl-carousel" id="product-image"><a href="<?= base_url() . "assets/images/koleksi/" . $foto_koleksi ?>" target="_blank"><img src="<?= base_url() . "assets/images/koleksi/" . $foto_koleksi ?>" alt="" class="w-75 mx-auto"> </a>
                    </div>
                </div>
