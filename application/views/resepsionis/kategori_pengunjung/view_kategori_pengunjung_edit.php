        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Edit Kategori Pengunjung</h3>
            </div>

            <form action="<?= base_url('resepsionis/edit_kategori_pengunjung') ?>" method="post" class="form-horizontal">
              <div class="card-body">

                <input type='hidden' name='id' value='<?= $rows['id_kategori_pengunjung']; ?>'>
