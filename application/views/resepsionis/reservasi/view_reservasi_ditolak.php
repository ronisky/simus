                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row['tanggal']; ?></td>
                                            <td><?= $row['waktu']; ?></td>
                                            <td class="text-danger"><strong><?= $row['id_reservasi'] ?></strong></td>
                                            <td>
                                                <?= $s ?>
                                            </td>
                                            <td>
                                                ...
                                                <a class='btn btn-success btn-xs' title='Ubah' href='<?php echo site_url('resepsionis/edit_reservasi_ditolak/') . encrypt_url($row['id_reservasi']); ?>'><i class='fas fa-edit fa-fw'></i></a>
