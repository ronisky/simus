                ...
                <tbody>
                  ...
                  foreach ($record as $row) { ?>
                    <tr>
                      <td><?= $no; ?></td>
                      <td>
                        <a class='btn btn-primary btn-xs' title='Detail' href=' <?= base_url('resepsionis/detail_faq/') . encrypt_url($row['id_faq']) ?>'><i class='fas fa-eye fa-fw'></i></a>
                        <a class='btn btn-success btn-xs' title='Ubah' href='<?php echo site_url('resepsionis/edit_faq/') . encrypt_url($row['id_faq']); ?>'><i class='fas fa-edit fa-fw'></i></a>
