                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body ml-5 mb-5">
                            ...
                            <form action="<?= base_url('resepsionis/cetak_rekap1') ?>" method="POST">
                                <div class="form-group row">
                                    <span class="col-sm-3 col-form-label">Pengunjung TK / PAUD</span>
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="tk" readonly value="<?= $jmlPengunjungTK1; ?>"></input>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 col-form-label">Pengunjung SD</span>
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="sd" readonly value="<?= $jmlPengunjungSD1; ?>"></input>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 col-form-label">Pengunjung SMP</span>
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="smp" readonly value="<?= $jmlPengunjungSMP1; ?>"></input>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 col-form-label">Pengunjung SMA</span>
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="sma" readonly value="<?= $jmlPengunjungSMA1; ?>"></input>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 col-form-label">Pengunjung Universitas / PT</span>
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="univ" readonly value="<?= $jmlPengunjungUniv1; ?>"></input>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 col-form-label">Pengunjung Umum</span>
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="umum" readonly value="<?= $jmlPengunjungUmum1; ?>"></input>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="nusan" readonly value="<?= $jmlPengunjungNusan1; ?>"></input>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 col-form-label">Wisatawan Mancanegara</span>
                                    <div class="col-sm-6">
                                        <input class="col-sm-2 col-form-label text-bold" name="manca" readonly value="<?= $jmlPengunjungMaca1; ?>"></input>
                                    </div>
                                </div>
                                <hr>
                                <hr>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="col-sm-3 col-form-label text-bold" name="total" readonly value="<?= $jmlPengunjung1; ?>"></input>
                                    </div>
                                </div>
                                <div class="form-group row">
