...
{
    protected $_ci;
    protected $email_pengirim = 'email@ronisky.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Museum Monumen Perjuangan Rakyat Jawa Barat'; // Isikan dengan nama pengirim
    protected $password = 'Monpera2020'; // Isikan dengan password email pengirim
    ...
    public function send($data)
    {
        ...
        $mail->AddEmbeddedImage('assets/images/favicon.png', 'logo_museum', 'favicon.png'); // Aktifkan jika ingin menampilkan gambar dalam email
